...
const OrderDetails = (props) => {
  const {imageSrc, orderID, price, date, driverStatus, restaurantName, restaurantLocation} = props;
      ...
      <div className="flex flex-row justify-between px-3 mt-5 mb-8">
        ...
        <div>
          <p
            ...
            style={{
              backgroundColor:
                driverStatus.includes("Assigned") ? "#C9EADE" :
                driverStatus === "Reached Pickup" ? "#C9DEF2" :
                driverStatus === "Order Picked up" ? "#F4E9CF" :
                driverStatus === "In-delivery" ? "#F4DFCF" :
                driverStatus === "Delivered" ? "#D1EDEC" :
                ""
            }}
          >
            {driverStatus}
         ...
         >
          <div className="bg-white w-[95vw] h-[80vw] md:h-[45vw] md:w-[60vw] lg:w-[45vw] lg:h-[35vw] xl:w-[40vw] xl:h-[30vw] 2xl:w-[35vw] 2xl:h-[25vw] rounded-3xl">
            <div className="flex justify-between px-5 py-2 md:p-4 bg-[#E8ECEE] rounded-t-3xl"> 
             ...
             <div className="p-4">
              <p className="text-[#3582CD] font-extrabold tracking-widest">ETA: 27MINS</p>
              ...
              <div className="bg-[#f8f8f8] py-2 md:py-3 mt-2 md:mt-4 rounded-xl flex justify-center md:justify-between md:px-3 gap-8 md:gap-5">
                ...
                <div className="flex flex-col items-center mt-2">
                  <div className="mb-5 md:mb-4 font-semibold">
                    <p className="text-sm md:text-base whitespace-nowrap">SS Hyerdrabad </p>
                  </div>
                  <p className="font-semibold text-[#8E9091] text-sm md:text-base">Anna Nagar</p>
                </div>
                ...
                <div className="flex flex-col items-center mt-2">
                  ...
                  <p className="font-semibold text-[#8E9091] hidden md:block">9:43 AM</p>
                </div>
              </div>

{/* 
              <div className="mt-5 flex items-center">
                <span className="bg-gradient-to-r from-[#EF2560] to-[#9C226D] w-8 h-8 rounded-full relative "></span>
                <span className="bg-gradient-to-r from-[#EF2560] to-[#9C226D] w-32 h-4 absolute "></span>
                <span className="bg-gradient-to-r from-[#EF2560] to-[#9C226D] w-8 h-8 rounded-full"></span>
                <span className="bg-gradient-to-r from-[#EF2560] to-[#9C226D] w-32 h-4 "></span>
                <span className="bg-gradient-to-r from-[#EF2560] to-[#9C226D] w-8 h-8 rounded-full"></span>
                <span className="bg-gradient-to-r from-[#EF2560] to-[#9C226D] w-32 h-4 "></span>
                <span className="bg-gradient-to-r from-[#EF2560] to-[#9C226D] w-8 h-8 rounded-full"></span>
              </div> */}
